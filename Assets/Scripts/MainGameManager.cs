...
public class MainGameManager : MonoBehaviour
{
    ...
    public void ToggleBothWindowHavers()
    {
        ...
        highestAcc.text = "Most likely culprit at Row: " + maxBall.RelatedHumanGameObject.GetComponent<Culprit>().floor + ", Col:" + maxBall.RelatedHumanGameObject.GetComponent<Culprit>().column + " has Acc of " + maxBall.Accuracy.ToString("F1") + "%";
